...
RSpec.describe FloorPlansController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested floor_plan as @floor_plan" do
      floor_plan = FloorPlan.create! valid_attributes
      get :show, {:id => floor_plan.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested floor_plan as @floor_plan" do
      floor_plan = FloorPlan.create! valid_attributes
      get :edit, {:id => floor_plan.to_param}, valid_session
      expect(assigns(:floor_plan)).to eq(floor_plan)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new FloorPlan" do
        expect {
          post :create, {:floor_plan => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved floor_plan as @floor_plan" do
        post :create, {:floor_plan => invalid_attributes}, valid_session
        expect(assigns(:floor_plan)).to be_a_new(FloorPlan)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, {:id => floor_plan.to_param, :floor_plan => new_attributes}, valid_session
        floor_plan.reload
      ...
      it "assigns the requested floor_plan as @floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, {:id => floor_plan.to_param, :floor_plan => valid_attributes}, valid_session
        expect(assigns(:floor_plan)).to eq(floor_plan)
      end
    ...
    describe "with invalid params" do
      it "assigns the floor_plan as @floor_plan" do
        floor_plan = FloorPlan.create! valid_attributes
        put :update, {:id => floor_plan.to_param, :floor_plan => invalid_attributes}, valid_session
        expect(assigns(:floor_plan)).to eq(floor_plan)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested floor_plan" do
      floor_plan = FloorPlan.create! valid_attributes
      expect {
        delete :destroy, {:id => floor_plan.to_param}, valid_session
      }.to change(FloorPlan, :count).by(-1)
    end
